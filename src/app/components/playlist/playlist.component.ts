...
export default class PlaylistComponent implements OnInit {
   ...
   */
  constructor(private rsvpService: RsvpAdapterService) {}
  ...
  submitSuggestion(): void {
    ...
    this.rsvpService.guardarSugerencia(
  invitadoIdNumber,
  email,
  this.songInput.song_name,
  this.songInput.artist
).subscribe({
  next: () => {
    this.songInput = { song_name: '', artist: '' };
